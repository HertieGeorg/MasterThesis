...
# Out: BP_Edits(Table4_Exp)_Model_Results_Count.html - Count part
stargazer(M3_ZeroInfl, M3_ZeroInfl_AltSpecA, M3_ZeroInfl_AltSpecE,  
          ...
          title="Table 6. Modeling the number of beneficial edits using ZINB: Different specifications", model.names = F, 
          ...
          out="Table 6 (BP_Edits(Table4_Exp)_ZinB_Specifications_Count).html", 
          omit = c("Constant"),
          type = "text")
...
# Out: BP_Edits(Table3_Exp)_Model_Results_Zero.html - Zero part
stargazer(M3_ZeroInfl, M3_ZeroInfl_AltSpecA, M3_ZeroInfl_AltSpecE,  zero.component = TRUE,
          ...
          covariate.labels=c("District Competitiveness", "Gender(Male)", "Age", "External Edits", 
                             "110th Session", "111th Session", "112th Session", "113th Session", 
                             "114th Session", "Party Affiliation(R)", "Chamber(Senate)"),
          title="Table 5. Modeling the likelihood of beneficial edits using ZINB: Different specifications", model.names = F, 
          ...
          align=TRUE, omit.stat=c("aic", "theta" ),
          omit = c("Constant"),
          out="Table 5 (BP_Edits(Table3_Exp)_ZinB_Specifications_Zero).html",  type = "text")
