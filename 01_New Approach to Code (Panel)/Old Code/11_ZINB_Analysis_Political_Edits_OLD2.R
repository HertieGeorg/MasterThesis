...
# ZinB-Model: 
# Depdendent Variable: All_Positive_Politically_CongressEdits_Per_MoC_Session
...
100*sum(df_Zinb$All_Positive_Politically_CongressEdits_Per_MoC_Session == 0)/nrow(df_Zinb) #83.75% sind Zeros
...
dp # = 4.222105 which is much higher than 1 -> strong overdispersion
...
stargazer(M1, M1_quasi, M2_negBinom, M3_ZeroInfl, 
          ...
          out="PositivePoliticalEdits(1)_Model_Results.html",  type = "text", 
...
M3_ZeroInfl_AltSpecA <- zeroinfl(All_Positive_Politically_CongressEdits_Per_MoC_Session ~ Category_Vote_MaxDiff + sex + birthyear +
...
M3_ZeroInfl_View <- zeroinfl(All_Positive_Politically_CongressEdits_Per_MoC_Session ~ Category_Vote_MaxDiff + sex + birthyear + ExternalEdits_per_MoC_Session + session + party_dual + Chamber + ViewCategory  | session + ViewCategory + ExternalEdits_per_MoC_Session,
                               data = df_Zinb , dist = "negbin")
...
M3_ZeroInfl_AltSpec_NoDoubles <- zeroinfl(All_Positive_Politically_CongressEdits_Per_MoC_Session ~ Category_Vote_MaxDiff + sex + birthyear +
                                   ExternalEdits_per_MoC_Session + session + party_dual + Chamber | session + ExternalEdits_per_MoC_Session ,
...
# Out: PositivePoliticalEdits(2)_ZinB_Specifications.html
...
stargazer(M3_ZeroInfl, M3_ZeroInfl_AltSpecA, M3_ZeroInfl_AltSpec_NoDoubles, M3_ZeroInfl_View,
          ...
          out="PositivePoliticalEdits(2)_ZinB_Specifications.html",  type = "text", 
...
# Ad 1/3
M3_ZeroInfl_AltSpec1 <- zeroinfl(All_Maintenance_CongressEdits_Per_MoC_Session  ~ Category_Vote_MaxDiff_3 + sex + birthyear +
                                   ExternalEdits_per_MoC_Session + session + party_dual + Chamber | session + ExternalEdits_per_MoC_Session,
                                 data = df_Zinb , dist = "negbin")
...
# Ad 1/5
M3_ZeroInfl_AltSpec2 <- zeroinfl(All_Maintenance_CongressEdits_Per_MoC_Session  ~ Category_Vote_MaxDiff_5 + sex + birthyear +
                                   ExternalEdits_per_MoC_Session + session + party_dual + Chamber | session + ExternalEdits_per_MoC_Session ,
                                 data = df_Zinb , dist = "negbin")
...
# Ad 1/6
M3_ZeroInfl_AltSpec3 <- zeroinfl(All_Maintenance_CongressEdits_Per_MoC_Session  ~ Category_Vote_MaxDiff_6 + sex + birthyear +
                                   ExternalEdits_per_MoC_Session + session + party_dual + Chamber | session + ExternalEdits_per_MoC_Session ,
                                 data = df_Zinb , dist = "negbin")
...
M3_ZeroInfl_AltSpec4 <- zeroinfl(All_Maintenance_CongressEdits_Per_MoC_Session  ~ vote_maxdiff_relative + sex + birthyear +
                                   ExternalEdits_per_MoC_Session + session + party_dual + Chamber | session + ExternalEdits_per_MoC_Session ,
                                 data = df_Zinb , dist = "negbin")
...
# Ad 1/2
M3_ZeroInfl_AltSpec5 <- zeroinfl(All_Maintenance_CongressEdits_Per_MoC_Session  ~ Category_Vote_MaxDiff_2 + sex + birthyear +
                                   ExternalEdits_per_MoC_Session + session + party_dual + Chamber | session + ExternalEdits_per_MoC_Session ,
                                 data = df_Zinb , dist = "negbin")
...
# Out: PositivePoliticalEdits(3_Appendix)_ZinB_VoteDiffCategories.html 
...
stargazer(M3_ZeroInfl_AltSpec5, M3_ZeroInfl_AltSpec1, M3_ZeroInfl, M3_ZeroInfl_AltSpec2, M3_ZeroInfl_AltSpec3, M3_ZeroInfl_AltSpec4,
          ...
          out="PositivePoliticalEdits(3_Appendix)_ZinB_VoteDiffCategories.html",  type = "text",  
...
M3_ZeroInfl_AltCount <- zeroinfl(All_Positive_Politically_CongressEdits_Per_MoC_Session ~ Category_Vote_MaxDiff + sex + birthyear +
...
M3_ZeroInfl_AltCount2 <- zeroinfl(All_Positive_Politically_CongressEdits_Per_MoC_Session ~ Category_Vote_MaxDiff + sex + birthyear +
...
# Out: PositivePoliticalEdits(4_Appendix)_ZinB_DifferentCounts.html
stargazer(M3_ZeroInfl, M3_ZeroInfl_AltCount, M3_ZeroInfl_AltCount2, 
          ...
          out="PositivePoliticalEdits(4_Appendix)_ZinB_DifferentCounts.html",  type = "text", 
          title="Zero-inflated models: different variables in logit part", align=TRUE) 



# Out: PositivePoliticalEdits(5_Appendix)_ZinB_DifferentCounts.html
