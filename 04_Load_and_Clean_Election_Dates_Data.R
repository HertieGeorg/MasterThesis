...
# This code can be used in case I want to include elections with NAs at some point 
  # converting NAs in day cloumn into 1
  #election_data$day <- ifelse(is.na(election_data$day), 1, election_data$day)
  #table(election_data$day) # all days with value 1 are former NAs

  # converting NAs in month cloumn into 1
  #election_data$month <- ifelse(is.na(election_data$month), 1, election_data$month)
  #table(election_data$month) # 9 out 10 month with value 1 are former NAs
